...
const communitiesData = [
  ...
  {
    name: "Jane's Youtube Community",
    description:
      "Community for Jane's YouTube channel followers - learn web development, coding tips, and career advice",
  },
  {
...
const learningGoalsData = {
  ...
  "Jane's Youtube Community": [
    ...
    },
    {
      ...
      description: "Learn from Jane's experience creating tech content",
    },
  ],
...
const freeUserAssignments = {
  ...
  "Free User Two": {
    community: "Jane's Youtube Community",
...
async function comprehensiveSeed() {
  ...
  try {
    ...
    const matchPairs = [
      ...
      ["John Doe", "Jane D", "Jane's Youtube Community"],
    ...
    console.log("   • jane.doe1@gmail.com");
    console.log("\n💡 OTHER TEST ACCOUNTS:");
    ...
    console.log("   • Jane's Youtube Community");
